  ...
  <body>
    ...
    <div class="payment__container">
      <div class="payment__left">
        ...
        <p>1 year membership of Sunway Music Society</p>
        <h1>RM15.00</h1>
        <p>Yey! You are taking the first step!</p>
      </div>
      ...
      <div class="payment__right">
        ...
        <input
          type="email"
          placeholder="email"
          value="20042206@imail.sunway.edu.my"
          disabled
        />
        ...
        <button id="card-btn" class="btn btn-method">
          <i class="uil uil-credit-card"></i>card
        </button>
        <button id="fpx-btn" class="btn btn-method">
          <i class="uil uil-exchange"></i>FPX
        </button>
        <button id="tng-btn" class="btn btn-method">
          <i class="uil uil-qrcode-scan"></i>TnG
        </button>
        ...
        <form class="tng">
          <h4>Name</h4>
          <input type="text" name="name" required />
          <h4>Scan QR to make payment</h4>
          <img src="../Images/touchngo.jpg" alt="tng" />
