...
<html lang="en">
  ...
  <div class="container topnav__container">
    ...
    <div class="content">
      <section class="mybooking__class">
        <h2>MY BOOKINGS</h2>
        <div class="container mybooking__container">

        <?php

              $sql = "SELECT e.* FROM events e, event_bookings ebk WHERE `Student ID` = '$member_id' AND e.`Event ID` = ebk.`Event ID`;";
