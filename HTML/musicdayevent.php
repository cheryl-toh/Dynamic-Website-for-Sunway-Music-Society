...
<html lang="en">
  <head>
    ...
    <title>World's Music Day |SMS</title>
      ...
      <div class="container eventdetails__container">
        <aside class="eventdetails__aside">
          ...
          <ul class="event__details">
            ...
            <li>
              <h5>Date: 21st June 2022</h5>
            </li>

            <li>
              <h5>Venue: Auditorium 1, Level M, Sunway University</h5>
            </li>
          </ul>
