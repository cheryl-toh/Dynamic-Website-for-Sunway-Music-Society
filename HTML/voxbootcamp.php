...
<html lang="en">
  <head>
    ...
    <title>Vocalist Bootcamp |SMS</title>
      ...
      <div class="container eventdetails__container">
        <aside class="eventdetails__aside">
          ...
          <ul class="event__details">
            ...
            <li>
              <h5>Date: 23st July 2022</h5>
            </li>

            <li>
              <h5>Venue: Auditorium 3, Level M, Sunway University</h5>
            </li>
          </ul>
